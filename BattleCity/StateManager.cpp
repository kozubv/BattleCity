...
StateManager::StateManager(SharedContext* l_shared) : m_shared(l_shared) {
  ...
  RegisterState<State_TanksMenu>(StateType::TanksMenu);
  RegisterState<State_LevelSelection>(StateType::LevelSelection);
  RegisterState<State_BattleReport>(StateType::BattleReport);
  RegisterState<State_Battle>(StateType::Battle);
}
